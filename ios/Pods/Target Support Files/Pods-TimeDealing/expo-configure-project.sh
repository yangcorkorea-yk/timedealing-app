...
with_node \
  ...
  --target "/Users/alex/timedealing-app/ios/Pods/Target Support Files/Pods-TimeDealing/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-router" "expo-secure-store" "expo-web-browser"
